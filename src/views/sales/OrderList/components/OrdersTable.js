...
import { Table, Tooltip, Input, Button, Empty } from 'antd'
import {
    EyeOutlined,
    InfoCircleTwoTone,
    DeleteOutlined,
...
const OrdersTable = () => {
    ...
    //  if (error) {
    //      return (
    //          <Empty description="Failed to fetch orders. Please try again later." />
    //      )
    //  }

    //  if (loading || data.length === 0) {
    //      return <Empty description="Loading orders..." />
    //  }
